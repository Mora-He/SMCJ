...
#CPP_FLAGS += -I /home/lidaoyi/Downloads/opencv-master/build/install/include/opencv4
...
#LD_FLAGS += $(addprefix -L, /home/lidaoyi/Downloads/opencv-master/build/install/lib)


LD_FLAGS += $(addprefix -L, /opt/hisi-linux/x86-arm/arm-himix200-linux/arm-linux-gnueabi/lib)
# LD_FLAGS += $(addprefix -L, /opt/hisi-linux/x86-arm/arm-himix200-linux/lib)
