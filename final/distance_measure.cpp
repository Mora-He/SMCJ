...
// int SendPic(const cv::Mat *left, const cv::Mat *right, cv::Mat *result_id)
{
	...
	// printf("mark match\n");
	int min_dst = matcher->stereo_match(left_mat, right_mat);
	// printf("mark match end\n");
	...
	// // matcher->count++;
	// if(matcher->count % 50 == 0)
	// {
	// 	printf("count:%d\n",matcher->count);
	// 	// strcpy(path,path_left);
	// 	path = "/mnt/app/photos/left" + std::to_string(matcher->count/50) + ".jpg";
	// 	// strcat(path,std::to_string(count/1000));
	// 	cv::imwrite(path,left_mat);
	// 	// strcpy(path,path_right);
	// 	path = "/mnt/app/photos/right" + std::to_string(matcher->count/50) + ".jpg";
	// 	// strcat(path,itoa(count/1000));
	// 	cv::imwrite(path,right_mat);
	// }
