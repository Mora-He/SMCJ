...
int stereo_match(int argc, char** argv)
{
	...
	cv::CommandLineParser parser(argc, argv,
		//"{@arg1|left.jpg|}{@arg2|right.jpg|}{help h||}{algorithm|bm|}{max-disparity|256|}{blocksize|7|}{no-display||}{color||}{scale|1|}{i||}{e||}{o|./disparity.jpg|}{p||}");
		"{@arg1|left.jpg|}{@arg2|right.jpg|}{help h||}{algorithm|bm|}{max-disparity|256|}{blocksize|7|}{no-display||}{color||}{scale|1|}{i|intrinsics.yml|}{e|extrinsics.yml|}{o|./disparity.jpg|}{p|./point_cloud.txt|}");
	if (parser.has("help"))
	{
		print_help(argv);
		return 0;
